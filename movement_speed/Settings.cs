...
public class Settings {
    ...
    public void early_load(DDPlugin plugin) {
        ...
        m_speed_multiplier = this.create_entry("General", "Movement Speed Multiplier", 1f, "Multiplier applied to movement speed (float, default 1f [normal speed]).  Changes to this value require a game restart.", on_setting_changed);
    }
