...
public class Settings {
    ...
    public static ConfigEntry<int> m_upgrade_days;
    ...
    public void early_load(DDPlugin plugin) {
        ...
        m_upgrade_days = this.create_entry("General", "Days to Upgrade", 2, "Number of days required for tool upgrade (int, default 2 [game default]).  Set this value to 0 to make blacksmith return the upgraded tool as soon as you speak with him again.", on_setting_changed);
    }
